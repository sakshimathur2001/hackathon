...
<?php 
  ...
  <div class="row">
   <div class="col-sm-12 ">
    ...
    <img src="images/world.gif" alt="Earth" style="width:100%">
</div>
...
<div id="myCarousel" class="carousel slide loop" data-ride="carousel">
  ...
  <!-- Wrapper for slides -->
  <div class="carousel-inner autoplay col-sm-6 column"><!--should I keep in autoplay-->
...
<div class="col-sm-6 column ">
  <img src="images/donatePic.png " width="100%" height="350px"  margin="0"  >
  <a href="#"><!--LINK-->
   <button type="button" class="btn btn-outline-primary button-left">Donate</button>
  </a>
  <a href="sectorReport.html">
   <button type="button" class="btn btn-outline-primary button-right">Monthly Sector Report</button>
  </a>
</div>
</div>
...
<div id="myCarousel2" class="carousel slide" data-ride="carousel">
  ...
  <!-- Wrapper for slides -->
  <div class="carousel-inner"><!--should I keep in autoplay-->
    <div class="item active">
